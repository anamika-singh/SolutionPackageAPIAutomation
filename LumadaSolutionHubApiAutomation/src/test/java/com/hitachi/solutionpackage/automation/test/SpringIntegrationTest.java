...
public class SpringIntegrationTest {
    ...
    void executePost() throws IOException {
        final Map<String, String> headers = new HashMap<>();
        headers.put("Authorization", "anamika:Rean@12345");
        ...
        latestResponse = restTemplate
          .execute("https://ciinfrartest-reanplatform-docker-1194834387.us-east-1.elb.amazonaws.com/api/reansolutionpackage/solution_package", HttpMethod.POST, requestCallback, response -> {
              if (errorHandler.hadError) {
                  return (errorHandler.getResults());
              } else {
                  return (new ResponseResults(response));
